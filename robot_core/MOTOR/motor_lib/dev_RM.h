...
#define C610_CURR_DATA_MAX   10000 ///< C610 maximum current
...
#define GM6020_VOLT_DATA_MAX 25000      //< 2020年旧版GM6020为30000
#define GM6020_VOLT_MAX      25.2f      //
#define GM6020_VOLT_RATED    24.f       //< 额定电压
#define GM6020_CURR_DATA_MAX 8192       //
#define GM6020_CURR_RATED    1.62       //< 额定电流
...
void RM_QUAD_motor_register(motor_t *pmotor, RM_QUAD_motor_model_t motor_model,
                            ...
                            motor_institution_t inst,float min_angle,float max_angle);
